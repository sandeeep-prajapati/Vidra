...
class CorePackageServiceProvider extends ServiceProvider
{
    ...
    private function registerDefaultMenuItems(): void
    {
        ...
        // Dashboard
        if (Auth::check()) {
            $menu->addItem('dashboard', new MenuItem(
                'Dashboard',
        ...
        // People section
        if (Auth::check() && Auth::user()->can('view-students')) {
            $menu->addItem('people', new MenuItem(
                'Students',
        ...
        if (Auth::check() && Auth::user()->can('view-staff')) {
            $menu->addItem('people', new MenuItem(
                'Staff',
        ...
        // Academics section
        $menu->addItem('academics', new MenuItem(
            'Academic Years',
        ...
        $menu->addItem('academics', new MenuItem(
            'Sections',
            '<svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 10h16M4 14h16M4 18h16"/></svg>',
            'sections.index',
            'academics'
        ));
        ...
        // Subjects section
        $menu->addItem('subjects', new MenuItem(
            'Subjects',
        ...
        $menu->addItem('subjects', new MenuItem(
            ...
            'teacher-subject-mappings.index',
            'subjects'
        ));

        // Attendance section
        $menu->addItem('attendance', new MenuItem(
            'Overview',
        ...
        // Finance section
        $menu->addItem('finance', new MenuItem(
            'Fee Categories',
            '<svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A2 2 0 013 12V7a2 2 0 012-2z"/></svg>',
            'feeCategory.index',
            'finance'
        ));
        ...
        $menu->addItem('finance', new MenuItem(
            ...
            'studentDiscount.index',
            'finance'
        ));

        $menu->addItem('finance', new MenuItem(
            'Expenses',
            '<svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/></svg>',
            'expense.index',
            'finance'
        ));
        ...
        $menu->addItem('finance', new MenuItem(
            'Financial Reports',
            '<svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>',
            'financialReport.index',
            'finance'
        ));

        // Timetable section
        $menu->addItem('timetable', new MenuItem(
            'Timetable',
            '<svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>',
            'timetable.index',
            'timetable'
        ...
        $menu->addItem('timetable', new MenuItem(
            'Days',
            '<svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 10h16M4 14h16M4 18h7"/></svg>',
            'day.index',
            'timetable'
        ));
        ...
        $menu->addItem('communication', new MenuItem(
            'Messages',
        ...
        $menu->addItem('hostel', new MenuItem(
            'Hostels',
            '<svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>',
            'hostels.index',
            'hostel'
        ...
        $menu->addItem('hostel', new MenuItem(
            'Hostel Assignments',
            '<svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>',
            'student-hostels.index',
            'hostel'
        ));

        $menu->addItem('hostel', new MenuItem(
            'Transportation',
            '<svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 17h8m-8 0H6a2 2 0 01-2-2V7a2 2 0 012-2h12a2 2 0 012 2v8a2 2 0 01-2 2h-2m-8 0v2a2 2 0 002 2h4a2 2 0 002-2v-2"/></svg>',
        ...
        $menu->addItem('hostel', new MenuItem(
            ...
            '<svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>',
            'student-transport.index',
            'hostel'
        ));

        $menu->addItem('hostel', new MenuItem(
            'Facilities',
            '<svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 14v3m4-3v3m4-3v3M3 21h18M3 10h18M3 7l9-4 9 4M4 10h16v11H4V10z"/></svg>',
            'facilities.index',
            'hostel'
        ));
        ...
        $menu->addItem('hostel', new MenuItem(
            'Facility Bookings',
            '<svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>',
            'facility-bookings.index',
            'hostel'
        ));

        // Exams section
        $menu->addItem('exams', new MenuItem(
            'Exams',
            '<svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/></svg>',
            'exam.index',
            'exams'
        ...
        $menu->addItem('exams', new MenuItem(
            'Report Cards',
            '<svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>',
            'studentReportCard.index',
            'exams'
        ));

        // Data Transfer section (single item, no button)
        $menu->addItem('datatransfer', new MenuItem(
            'Import / Export',
        ...
        // RBAC section
        if (Auth::check() && Auth::user()->can('view-rbac')) {
            $menu->addItem('rbac', new MenuItem(
                'Roles',
            ...
            $menu->addItem('rbac', new MenuItem(
                'Permissions',
                '<svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z"/></svg>',
                'permissions.index',
                'rbac'
            ));
        ...
        if (Auth::check() && Auth::user()->can('create-rbac')) {
            $menu->addItem('rbac', new MenuItem(
                'Create User',
                '<svg class="icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"/></svg>',
                'users.create',
                'rbac'
            ));
        }
        ...
        // System section
        if (Auth::check() && Auth::user()->can('view-system-settings')) {
