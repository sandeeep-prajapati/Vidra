...
<div style="max-width:640px;">
    <div style="margin-bottom:1.5rem;">
        <h1 style="font-size:1.375rem;font-weight:700;color:#1e293b;margin:0;">Add Room</h1>
        <p style="font-size:.8125rem;color:#64748b;margin:.25rem 0 0;">Register a new room or space</p>
    </div>
        ...
        <form method="POST" action="{{ route('room.store') }}">
            ...
            <div style="display:flex;flex-direction:column;gap:1.25rem;">
                <x-core-package::form.input name="room_name" label="Room Name" required
                    hint="e.g. 101, Physics Lab, Main Auditorium"
                    value="{{ old('room_name') }}" />
                ...
                <x-core-package::form.textarea name="description" label="Description" rows="3"
                    hint="Optional notes about this room">{{ old('description') }}</x-core-package::form.textarea>
                ...
                <div style="display:flex;gap:.75rem;">
                    <x-core-package::btn type="submit" color="primary">Save Room</x-core-package::btn>
