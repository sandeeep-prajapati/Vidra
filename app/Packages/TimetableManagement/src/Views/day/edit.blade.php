...
<nav style="font-size:.8125rem;color:#64748b;">
    ...
    <span style="color:#374151;font-weight:500;">Edit Day</span>
</nav>
@endsection
...
<div style="max-width:480px;">
    <div style="margin-bottom:1.5rem;">
        <h1 style="font-size:1.375rem;font-weight:700;color:#1e293b;margin:0;">Edit Day</h1>
    </div>

    <x-core-package::card>
        <form method="POST" action="{{ route('day.update', $day) }}">
            @csrf @method('PUT')
            <div style="display:flex;flex-direction:column;gap:1.25rem;">
                ...
                <div style="display:flex;gap:.75rem;">
                    <x-core-package::btn type="submit" color="primary">Update Day</x-core-package::btn>
