...
<nav style="font-size:.8125rem;color:#64748b;">
    <span style="color:#374151;font-weight:500;">Teacher Leave Requests</span>
</nav>
@endsection
...
<div style="display:flex;align-items:center;justify-content:space-between;gap:1rem;margin-bottom:1.5rem;">
    <div>
        <h1 style="font-size:1.375rem;font-weight:700;color:#1e293b;margin:0;">Teacher Leave Requests</h1>
        <p style="font-size:.8125rem;color:#64748b;margin:.25rem 0 0;">Manage leave applications submitted by staff members</p>
    </div>
    <x-core-package::btn :href="route('teacherLeaveRequest.create')" color="primary">
...
<x-core-package::card style="margin-bottom:1.25rem;">
    <form method="GET" action="{{ route('teacherLeaveRequest.index') }}"
          style="display:grid;grid-template-columns:1fr 160px auto auto;gap:.75rem;align-items:end;">
        <x-core-package::form.input name="staff_id" label="Staff ID" placeholder="Filter by staff ID" value="{{ request('staff_id') }}" type="number" />
        ...
        <div style="padding-top:1.375rem;"><x-core-package::btn :href="route('teacherLeaveRequest.index')" color="secondary">Reset</x-core-package::btn></div>
    </form>
</x-core-package::card>
            ...
            <tr style="border-bottom:1px solid #f1f5f9;">
                ...
                <td style="padding:.75rem 1rem;">
                    <div style="display:flex;gap:.5rem;align-items:center;">
                        <x-core-package::btn :href="route('teacherLeaveRequest.show', $item)" color="primary" size="sm">View</x-core-package::btn>
                        <x-core-package::btn :href="route('teacherLeaveRequest.edit', $item)" color="secondary" size="sm">Edit</x-core-package::btn>
                        <form method="POST" action="{{ route('teacherLeaveRequest.destroy', $item) }}"
