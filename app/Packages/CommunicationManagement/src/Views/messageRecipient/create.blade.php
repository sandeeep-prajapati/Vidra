...
<nav style="font-size:.8125rem;color:#64748b;">
    ...
    <span style="color:#374151;font-weight:500;">Add Recipient</span>
</nav>
@endsection
...
<div style="max-width:600px;">
    <div style="margin-bottom:1.5rem;">
        <h1 style="font-size:1.375rem;font-weight:700;color:#1e293b;margin:0;">Add Recipient</h1>
        <p style="font-size:.8125rem;color:#64748b;margin:.25rem 0 0;">Assign a user to receive a message</p>
    </div>
        ...
        <form method="POST" action="{{ route('messageRecipient.store') }}">
            ...
            <div style="margin-bottom:1rem;">
                <x-core-package::form.select name="message_id" label="Message" required>
                    ...
                    <option value="{{ $msg->message_id }}" @selected(old('message_id', request('message_id')) == $msg->message_id)>
            ...
            <div style="margin-bottom:1rem;">
                <x-core-package::form.select name="status" label="Delivery Status" required>
                    ...
                    <option value="{{ $s }}" @selected(old('status', 'Pending') === $s)>{{ $s }}</option>
                    @endforeach
                </x-core-package::form.select>
            </div>
            ...
            <div style="display:flex;gap:.75rem;">
                <x-core-package::btn type="submit" color="primary">Add Recipient</x-core-package::btn>
